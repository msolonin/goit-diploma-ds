...
class BoatModelDataset(Dataset):
    def __init__(self, csv_file, transform=None):
        ...
        # Extract model names as classes
...
dataset = BoatModelDataset(csv_path, transform)

train_idx, val_idx = train_test_split(
    range(len(dataset)), test_size=0.1, random_state=42, stratify=dataset.df["boat_model"]
)
