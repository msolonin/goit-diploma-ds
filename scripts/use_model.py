...
from scripts.base.constants import BOAT_TYPES, BOAT_TYPE, BOAT_MODEL, PHOTO_TYPE, PHOTO_TYPES_ALL, PHOTO_TYPES, DEFAULT_CSV_PATH, BOAT_CLASS_IN, TOP, THRESHOLD
