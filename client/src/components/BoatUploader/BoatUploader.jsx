    ...
    <Grid container spacing={3} sx={{ mt: 4 }}>
      <Grid item xs={12} md={debug ? 8 : 12}>
        <Box sx={{ maxWidth: 700, mx: "auto" }}>
          ...
          {/* Dropzone */}
          <Paper {...getRootProps()} sx={{ border: "2px dashed #ccc", p: 4, textAlign: "center", mb: 2, backgroundColor: isDragActive ? "#f0f0f0" : "inherit", cursor: "pointer", minWidth: 500, minHeight: 140 }}>
            <input {...getInputProps()} />
